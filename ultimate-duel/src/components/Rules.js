    ...
    return (
        <div className="rules">
            <div>
                ...
                <p>Each player starts with 3 hp and 1 charge. The player who reaches 0 hp loses.There are four actions that can be taken in game:</p>
                ...
                <p>Each player has 6 seconds to make their move. If they fail to do so, their character will shield!</p>
            </div>
